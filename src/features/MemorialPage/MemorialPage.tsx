        ...
        <section className={styles.group} key={group}>
          <Reveal distance="short">
            <p className="eyebrow eyebrow-dark">
              {lang === 'sv' ? 'R.I.P. / För alltid i groovet' : lang === 'fr' ? 'R.I.P. / À jamais dans le groove' : lang === 'fi' ? 'R.I.P. / Ikuisesti groovessa' : lang === 'ko' ? 'R.I.P. / 영원히 그루브 속에' : lang === 'ja' ? 'R.I.P. / 永遠にグルーヴの中に' : 'R.I.P. / Forever in the groove'}
            </p>
