          ...
          <Reveal className={styles.document} distance="short">
            <a href="/media/campbellock-jr/four-attributes.jpg" target="_blank" rel="noreferrer">
              <Image
                ...
                alt={lang === 'sv' ? 'Greg Campbellock Jr:s dokument The 4 attributes of Locking' : lang === 'fr' ? 'Le document The 4 attributes of Locking de Greg Campbellock Jr.' : lang === 'fi' ? 'Greg Campbellock Jr:n dokumentti The 4 attributes of Locking' : lang === 'ko' ? 'Greg Campbellock Jr.의 문서 The 4 attributes of Locking' : lang === 'ja' ? 'Greg Campbellock Jr.の資料「The 4 attributes of Locking」' : 'Greg Campbellock Jr.’s document The 4 attributes of Locking'}
                width={1834}
                height={3969}
