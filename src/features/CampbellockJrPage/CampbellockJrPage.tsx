          ...
          <Reveal className={styles.document} distance="short">
            <a href="/media/campbellock-jr/four-attributes.jpg" target="_blank" rel="noreferrer">
              <Image
                ...
                alt={lang === 'sv' ? 'Greg Campbellock Jr:s dokument The 4 attributes of Locking' : lang === 'fr' ? 'Le document The 4 attributes of Locking de Greg Campbellock Jr.' : lang === 'fi' ? 'Greg Campbellock Jr:n dokumentti The 4 attributes of Locking' : lang === 'ko' ? 'Greg Campbellock Jr.의 문서 The 4 attributes of Locking' : lang === 'ja' ? 'Greg Campbellock Jr.の資料「The 4 attributes of Locking」' : lang === 'zh' ? 'Greg Campbellock Jr. 的资料“The 4 attributes of Locking”' : 'Greg Campbellock Jr.’s document The 4 attributes of Locking'}
                width={1834}
                height={3969}
        ...
        <div className={styles.equationImage}>
          <a href="/media/campbellock-jr/funky-style.jpg" target="_blank" rel="noreferrer">
            <Image
              ...
              alt={lang === 'sv' ? 'Greg Campbellock Jr:s diagram BC plus EC plus precision moves with music equals Funky Style' : lang === 'fr' ? 'Le diagramme de Greg Campbellock Jr. : BC plus EC plus precision moves with music égale Funky Style' : lang === 'fi' ? 'Greg Campbellock Jr:n kaavio: BC plus EC plus precision moves with music on yhtä kuin Funky Style' : lang === 'ko' ? 'Greg Campbellock Jr.의 도표: BC + EC + 음악에 맞춘 precision moves = Funky Style' : lang === 'ja' ? 'Greg Campbellock Jr.の図：BC + EC + 音楽に合わせたprecision moves = Funky Style' : lang === 'zh' ? 'Greg Campbellock Jr. 的图示：BC + EC + 配合音乐的 precision moves = Funky Style' : 'Greg Campbellock Jr.’s diagram: BC plus EC plus precision moves with music equals Funky Style'}
              width={1783}
              height={2805}
