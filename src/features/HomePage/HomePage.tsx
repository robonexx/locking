    ...
    : lang === 'fr'
      ...
      : lang === 'fi'
        ...
        : lang === 'es'
          ? {
              eyebrow: 'Campbellocking · Locking · Los Angeles',
              titleLines: ['Cultura.', 'Danza.', 'Historia.'],
              lead: 'Un archivo cultural vivo sobre las personas, los lugares, la música y el movimiento detrás de Campbellocking y Locking.',
              cta: 'Empieza por la historia',
              archive: 'Conoce a los pioneros',
              heroAlt: 'Bailarines en la pista de Soul Train',
              manifestoEyebrow: 'Cultura / Contexto / Dar crédito',
              manifesto: 'Más que un estilo de danza.',
              manifestoBody: 'El Locking creció entre música, comunidad, expresión personal, orgullo y creatividad. Aquí contamos las personas, el contexto cultural y la danza como partes de una misma historia.',
              rhythm: 'Siente el ritmo. Conoce la historia.',
              rhythmEyebrow: 'Cultura en movimiento',
              rhythmIntro: 'Para comprender el Locking hay que escuchar la música y también ver la cultura de la que nació la danza. Groove, vestuario, carácter y la interacción entre personas no son adornos alrededor de los pasos: son partes fundamentales de toda la expresión.',
              musicEyebrow: 'Soul / Funk / Musicalidad',
              musicTitle: 'La música es una base del Locking',
              musicBody: 'Soul y funk aportan groove, pulso y actitud a la pista. Líneas de bajo, batería, breaks y acentos claros crean momentos para detenerse, explotar, jugar y responder. Locking no es simplemente bailar “encima” de la música: es una conversación entre el bailarín y la música.',
              clothesEyebrow: 'Estilo / Carácter / Identidad',
              clothesTitle: 'La ropa refuerza la expresión',
              clothesBody: 'Sombreros grandes, calcetines a rayas, pantalones ajustados o cortos, camisas de colores, moños y guantes se convirtieron en parte del lenguaje visual del Locking. En el escenario también pueden reforzar líneas, hat tricks y carácter. El estilo es una forma de expresión cultural y personal, no un uniforme obligatorio para bailar Locking.',
              musicAlt: 'Bailarines en la pista de Soul Train',
              clothesAlt: 'The Lockers con su vestuario escénico característico',
              sources: 'Fuentes culturales y lecturas adicionales',
              ways: 'Tres caminos para entrar',
              featured: 'Explora más del Locking',
              stories: 'Nuevas voces. Historias reales.',
              storiesEyebrow: 'Entrevistas / Editorial / Noticias',
              storiesBody: 'Entrevistas y artículos que dan espacio en Locking.se a más personas y perspectivas.',
              contactEyebrow: 'Preguntas / Correcciones / Historias',
              contactTitle: 'Ayuda a que la historia siga moviéndose.',
              contactBody: '¿Tienes conocimiento, una corrección o una historia que debería documentarse aquí? Ponte en contacto. También puedes seguir el trabajo y los encuentros alrededor de la danza a través de Funkcamp.',
              contact: 'Contactar a Locking.se',
              funkcamp: 'Visitar Funkcamp.se',
            }
        : lang === 'pt'
          ? {
              eyebrow: 'Campbellocking · Locking · Los Angeles',
              titleLines: ['Cultura.', 'Dança.', 'História.'],
              lead: 'Um arquivo cultural vivo sobre as pessoas, os lugares, a música e o movimento por trás do Campbellocking e do Locking.',
              cta: 'Comece pela história',
              archive: 'Conheça os pioneiros',
              heroAlt: 'Dançarinos na pista de dança do Soul Train',
              manifestoEyebrow: 'Cultura / Contexto / Reconhecimento',
              manifesto: 'Mais do que um estilo de dança.',
              manifestoBody: 'O Locking cresceu a partir da música, da comunidade, da expressão pessoal, do orgulho e da criatividade. Aqui, as pessoas, os contextos e o movimento recebem espaço juntos.',
              rhythm: 'Sinta o ritmo. Conheça a história.',
              rhythmEyebrow: 'Cultura em movimento',
              rhythmIntro: 'Para entender o Locking, é preciso ouvir a música e conhecer a cultura da qual a dança surgiu. Groove, roupas, caráter e interação social não são apenas elementos decorativos ao redor dos passos — eles ajudam a sustentar a expressão.',
              musicEyebrow: 'Soul / Funk / Musicalidade',
              musicTitle: 'A música é uma base do Locking',
              musicBody: 'Soul e funk deram à pista de dança groove, pulsação e atitude. Linhas de baixo, bateria, breaks e acentos marcantes criam momentos para parar, explodir, brincar e responder. O Locking não fica simplesmente por cima da música; o dançarino mantém uma conversa com ela.',
              clothesEyebrow: 'Estilo / Caráter / Identidade',
              clothesTitle: 'As roupas reforçam a expressão',
              clothesBody: 'Chapéus grandes, meias listradas, calças ajustadas ou mais curtas, camisas coloridas, gravatas-borboleta e luvas se tornaram parte da linguagem visual do Locking. No palco, podiam destacar linhas, hat tricks e personalidade. O estilo é uma expressão cultural e uma forma de apresentação pessoal — não um uniforme obrigatório para dançar.',
              musicAlt: 'Dançarinos na pista de dança do Soul Train',
              clothesAlt: 'The Lockers com seus figurinos de palco característicos',
              sources: 'Fontes culturais e leituras adicionais',
              ways: 'Três caminhos para começar',
              featured: 'Explore a dança',
              stories: 'Novas vozes. Histórias reais.',
              storiesEyebrow: 'Entrevistas / Editorial / Notícias',
              storiesBody: 'Entrevistas e artigos darão a mais pessoas e perspectivas um espaço próprio na Locking.se.',
              contactEyebrow: 'Perguntas / Correções / Histórias',
              contactTitle: 'Ajude a manter a história em movimento.',
              contactBody: 'Você tem conhecimento, uma correção ou uma história que deveria estar aqui? Entre em contato. Você também pode acompanhar o trabalho e os encontros em torno da dança pelo Funkcamp.',
              contact: 'Entrar em contato com a Locking.se',
              funkcamp: 'Visitar Funkcamp.se',
            }
        : lang === 'ko'
          ? {
