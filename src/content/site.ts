...
export const contentPages: ContentPage[] = [
  {
    ...
    kicker: { sv: 'Robert “Rob-One” Wägars väg till Locking', en: 'Robert “Rob-One” Wägar’s journey into Locking', fr: 'Le parcours de Robert « Rob-One » Wägar dans le Locking', fi: 'Robert ”Rob-One” Wägarin matka Lockingin pariin', ko: 'Robert “Rob-One” Wägar가 락킹을 만나온 여정' },
    title: { sv: 'Om Locking.se', en: 'About Locking.se', fr: 'À propos de Locking.se', fi: 'Tietoa Locking.se-sivustosta', ko: 'Locking.se 소개' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Från Campbellocking till Locking', en: 'From Campbellocking to Locking', fr: 'Du Campbellocking au Locking', fi: 'Campbellockingista Lockingiin', ko: '캠벨락킹에서 락킹으로' },
    title: { sv: 'Lockingens historia', en: 'The history of Locking', fr: 'L’histoire du Locking', fi: 'Lockingin historia', ko: '락킹의 역사' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Vi minns', en: 'We remember', fr: 'Nous nous souvenons', fi: 'Me muistamme', ko: '우리는 기억합니다' },
    title: { sv: 'Till minne av legenderna', en: 'In memory of the legends', fr: 'À la mémoire des légendes', fi: 'Legendojen muistolle', ko: '전설들을 기리며' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Kollektiv kraft', en: 'Collective power', fr: 'Force collective', fi: 'Yhteisön voima', ko: '함께 만든 힘' },
    title: { sv: 'Grupper & dansare', en: 'Groups & dancers', fr: 'Groupes & danseurs', fi: 'Ryhmät ja tanssijat', ko: '그룹 & 댄서' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Dansgolvet som förändrade allt', en: 'The dance floor that changed everything', fr: 'La piste de danse qui a tout changé', fi: 'Tanssilattia, joka muutti kaiken', ko: '모든 것을 바꾼 댄스 플로어' },
    title: { sv: 'Soul Train', en: 'Soul Train', fr: 'Soul Train', fi: 'Soul Train', ko: 'Soul Train' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Musik, motstånd och gemenskap', en: 'Music, resistance and community', fr: 'Musique, résistance et communauté', fi: 'Musiikki, vastarinta ja yhteisö', ko: '음악, 저항 그리고 공동체' },
    title: { sv: 'Wattstax', en: 'Wattstax', fr: 'Wattstax', fi: 'Wattstax', ko: 'Wattstax' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Original generation', en: 'Original generation', fr: 'Génération fondatrice', fi: 'Alkuperäinen sukupolvi', ko: '오리지널 세대' },
    title: { sv: 'Pionjärerna', en: 'The pioneers', fr: 'Les pionniers', fi: 'Pioneerit', ko: '파이오니어들' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Campbellock Jr. · Mentor · Pionjär', en: 'Campbellock Jr. · Mentor · Pioneer', fr: 'Campbellock Jr. · Mentor · Pionnier', fi: 'Campbellock Jr. · Mentori · Pioneeri', ko: 'Campbellock Jr. · 멘토 · 파이오니어' },
    title: { sv: 'The Line Captain', en: 'The Line Captain', fr: 'The Line Captain', fi: 'The Line Captain', ko: 'The Line Captain' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'En kultur i rörelse', en: 'A culture in motion', fr: 'Une culture en mouvement', fi: 'Liikkeessä oleva kulttuuri', ko: '움직이는 문화' },
    title: { sv: 'Tidslinjen', en: 'Timeline of Locking', fr: 'Chronologie du Locking', fi: 'Lockingin aikajana', ko: '락킹 타임라인' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Grunden i rörelsen', en: 'The foundation in motion', fr: 'Les fondations en mouvement', fi: 'Perusta liikkeessä', ko: '움직임 속의 기초' },
    title: { sv: 'Steg & rörelser', en: 'Steps & moves', fr: 'Pas & mouvements', fi: 'Askeleet ja liikkeet', ko: '스텝 & 무브' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Språket bär kulturen', en: 'Language carries culture', fr: 'La langue porte la culture', fi: 'Kieli kantaa kulttuuria', ko: '언어에는 문화가 담깁니다' },
    title: { sv: 'Gatuspråk & terminologi', en: 'Street terminology', fr: 'Vocabulaire de rue', fi: 'Katukieli ja terminologia', ko: '스트리트 용어' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Före scenen fanns festen', en: 'Before the stage, there was the party', fr: 'Avant la scène, il y avait la fête', fi: 'Ennen näyttämöä oli juhla', ko: '무대보다 먼저 파티가 있었습니다' },
    title: { sv: 'Social & Party Dances', en: 'Social & Party Dances', fr: 'Danses sociales & festives', fi: 'Social & Party Dances', ko: '소셜 & 파티 댄스' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Handshake of brotherhood', en: 'Handshake of brotherhood', fr: 'Une poignée de main fraternelle', fi: 'Veljeyden kädenpuristus', ko: '형제애의 핸드셰이크' },
    title: { sv: 'GoGo & YoYo Brothers', en: 'GoGo & YoYo Brothers', fr: 'GoGo & YoYo Brothers', fi: 'GoGo & YoYo Brothers', ko: 'GoGo & YoYo Brothers' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Gruppen som förändrade dansscenen', en: 'The group that changed the dance scene', fr: 'Le groupe qui a transformé la scène de la danse', fi: 'Ryhmä, joka muutti tanssikentän', ko: '댄스 신을 바꾼 그룹' },
    title: { sv: 'The Lockers', en: 'The Lockers', fr: 'The Lockers', fi: 'The Lockers', ko: 'The Lockers' },
    summary: {
  ...
  },
  {
    ...
    kicker: { sv: 'Röster från kulturen', en: 'Voices from the culture', fr: 'Les voix de la culture', fi: 'Kulttuurin ääniä', ko: '문화 속 목소리' },
    title: { sv: 'Intervjuer & artiklar', en: 'Interviews & articles', fr: 'Entretiens & articles', fi: 'Haastattelut ja artikkelit', ko: '인터뷰 & 기사' },
    summary: {
      sv: 'Coming soon.',
      en: 'Coming soon.',
  ...
  },
  {
    ...
    kicker: { sv: 'Hör av dig', en: 'Get in touch', fr: 'Écrivez-nous', fi: 'Ota yhteyttä', ko: '연락해 주세요' },
    title: { sv: 'Kontakt', en: 'Contact', fr: 'Contact', fi: 'Yhteystiedot', ko: '연락처' },
    summary: {
